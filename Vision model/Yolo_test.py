...
model = torch.hub.load('ultralytics/yolov5', 'custom',
                       path='E:/best_2.pt', source='github')

# Set video source (webcam or video file)
#video_path = 'E:/Drone-detection-dataset-master/Data/Video_V/V_DRONE_023.mp4'
#video_path = 'E:/Drone-detection-dataset-master/Data/Video_V/V_DRONE_010.mp4'
video_path = 'E:/Altitude Climb_Step 20m.MOV'
...
while True:
    ...
    for i in range(4):
        ...
        cv2.line(frame, rectangle_coords[i],
                 rectangle_coords[(i+1) % 4], (0, 255, 0), 2)
